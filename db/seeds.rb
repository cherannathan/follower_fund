...
user_2 = User.new(last_name: 'sinbad', first_name: 'captain', email: 'nrajapandey@gmail.com', password: '123456', bio: 'A combination of funny and serious with the creative entrepreneur in mind. ', role: 'creator', pseudo: 'Captain Sinbad', youtube_link: 'https://www.youtube.com/channel/UC8XKyvQ5Ne_bvYbgv8LaIeg', number_suscribers: 433000 )
...
user_4 = User.new(last_name: 'Mae', first_name: 'Lauren', email: 'laurenmaebeauty@gmail.com', password: '123456', bio: 'Why hello there! My name is Lauren and welcome to my channel! I love makeup and all things beauty so my channel is primarily centered on those topics but there are no limits so dont be surprised if you see something else pop up on here! Please do not be shy and come say hello!', role: 'creator', pseudo: 'Lauren Mae Beauty', youtube_link: 'https://www.youtube.com/channel/UCk_pgP3DpoPNEjn9NthCsAg', number_suscribers: 100000 )
...
user_5 = User.new(last_name: 'Makeup', first_name: 'Ray', email: 'disisreyrey@influint.co', password: '123456', bio: 'Hi ! Welcome to my beauty channel ! Im here to share some of the things I love such as makeup, hair and fashion. I hope you guys enjoy and please subscribe to see new uploads.', role: 'creator', pseudo: 'DisisReyRey', youtube_link: 'https://www.youtube.com/channel/UCYpjSJsH65ffZXdTfQHHpWA', number_suscribers: 137000)
...
user_7 = User.new(last_name: 'Garlsonn', first_name: 'Justin', email: 'JustDrawCats@gmail.com', password: '123456', bio: 'Do you like games? I do too. I hope you like my channel; I hope to get more investment to grow a lot more! ', role: 'creator', pseudo: 'JustDrawCats', youtube_link: 'https://www.youtube.com/user/justdrawcats', number_suscribers: 25000)
...
user_8 = User.new(last_name: 'Shekh', first_name: 'Irina', email: 'irina.tech@gmail.com', password: '123456', bio: 'Hey, guys! My name is Irina and I am happy to see you on my channel😊 Stay tuned for more of my tech reviews! ', role: 'creator', pseudo: 'Irina Tech', youtube_link: 'https://www.youtube.com/channel/UCToArA-nBRAgJq08fbQ0JgA', number_suscribers: 26000)
...
user_9 = User.new(last_name: 'Taki', first_name: 'Paul', email: 'Sandimas206@gmail.com', password: '123456', bio: ' I provide unboxings, reviews with tutorials so you can get the most out of your smartphone! ', role: 'creator', pseudo: 'Paul Taki', number_suscribers: 56000, youtube_link: 'https://www.youtube.com/channel/UCVcb5c_-h5HxMZobDTCzBkg' )
...
user_12 = User.new(last_name: 'May', first_name: 'James', email: 'jamesmay@gmail.com', password: '123456', bio: 'We create tutorials about anything and everything. Fro paper airplanes to japanese swords!', pseudo: 'Crazy Tutorials', role: 'creator', youtube_link: 'https://www.youtube.com/user/TheCrazyTutorialsHD', number_suscribers: 217000)
...
user_13 = User.new(last_name: 'Lasope', first_name: 'Tyler', email: 'devslopes@gmail.com', password: '123456', bio: 'Devslopes is the worlds most affordable and effective platform to learn how to code.', pseudo: 'Devslopes', role: 'creator', youtube_link: 'https://www.youtube.com/channel/UClLXKYEEM8OBBx85DOa6-cg', number_suscribers: 112000)
...
project_1.photo.attach(io: project_photo_1, filename:'french.png', content_type: 'image/png')
project_1.save!
